...
var Zepto = function () {
  function k(t) {
    ...
    for (e in i) r && (F(i[e]) || M(i[e])) ? (F(i[e]) && !F(n[e]) && (n[e] = {}), M(i[e]) && !M(n[e]) && (n[e] = []), U(n[e], i[e], r)) : i[e] !== t && (n[e] = i[e]);
  }function X(t, e) {
    ...
    e(t);for (var n = 0, i = t.childNodes.length; i > n; n++) Q(t.childNodes[n], e);
      ...
      N = { tabindex: "tabIndex", readonly: "readOnly", "for": "htmlFor", "class": "className", maxlength: "maxLength", cellspacing: "cellSpacing", cellpadding: "cellPadding", rowspan: "rowSpan", colspan: "colSpan", usemap: "useMap", frameborder: "frameBorder", contenteditable: "contentEditable" },
    ...
    if (!e || !t || 1 !== t.nodeType) return !1;var n = t.webkitMatchesSelector || t.mozMatchesSelector || t.oMatchesSelector || t.matchesSelector;if (n) return n.call(t, e);var i,
        r = t.parentNode,
        o = !r;return o && (r = A).appendChild(t), i = ~C.qsa(r, e).indexOf(t), o && A.removeChild(t), i;
  }, O = function (t) {
    ...
    var o, s, f;return p.test(e) && (o = n(u.createElement(RegExp.$1))), o || (e.replace && (e = e.replace(d, "<$1></$2>")), i === t && (i = h.test(e) && RegExp.$1), i in x || (i = "*"), f = x[i], f.innerHTML = "" + e, o = n.each(a.call(f.childNodes), function () {
      f.removeChild(this);
    ...
    var r;if (!e) return C.Z();if ("string" == typeof e) {
      ...
      if (D(e)) return n(u).ready(e);if (C.isZ(e)) return e;if (M(e)) r = _(e);else if ($(e)) r = [e], e = null;else if (h.test(e)) r = C.fragment(e.trim(), RegExp.$1, i), e = null;else {
        if (i !== t) return n(i).find(e);r = C.qsa(u, e);
      }
    }return C.Z(r, e);
  }, n = function (t, e) {
  ...
  }, n.type = k, n.isFunction = D, n.isWindow = Z, n.isArray = M, n.isPlainObject = F, n.isEmptyObject = function (t) {
    ...
    var n,
        r,
        o,
        i = [];if (R(t)) for (r = 0; r < t.length; r++) n = e(t[r], r), null != n && i.push(n);else for (o in t) n = e(t[o], o), null != n && i.push(n);return q(i);
  }, n.each = function (t, e) {
    var n, i;if (R(t)) {
    ...
    S["[object " + e + "]"] = e.toLowerCase();
      ...
      var i = [];if (D(e) && e.call !== t) this.each(function (t) {
        e.call(this, t) || i.push(this);
      });else {
        var r = "string" == typeof e ? this.filter(e) : R(e) && D(e.item) ? a.call(e) : n(e);this.forEach(function (t) {
      ...
      var i = this[0],
          r = !1;for ("object" == typeof t && (r = n(t)); i && !(r ? r.indexOf(i) >= 0 : C.matches(i, t));) i = i !== e && !L(i) && i.parentNode;return n(i);
    }, parents: function (t) {
      ...
      var e = D(t);if (this[0] && !e) var i = n(t).get(0),
      ...
      var e = D(t);return this.each(function (i) {
        var r = n(this),
            o = r.contents(),
      ...
      var r;return "string" != typeof n || 1 in arguments ? this.each(function (t) {
        if (1 === this.nodeType) if ($(n)) for (e in n) G(this, e, n[e]);else G(this, n, Y(this, i, t, this.getAttribute(n)));
      ...
      if (arguments.length < 2) {
        var r,
            o = this[0];if (!o) return;if (r = getComputedStyle(o, ""), "string" == typeof t) return o.style[O(t)] || r.getPropertyValue(t);if (M(t)) {
          var s = {};return n.each(t, function (t, e) {
            s[e] = o.style[O(e)] || r.getPropertyValue(e);
          }), s;
        }
      }var a = "";if ("string" == k(t)) i || 0 === i ? a = z(t) + ":" + W(t, i) : this.each(function () {
      ...
      return this.each(function (n) {
        if ("className" in this) {
          if (e === t) return J(this, "");i = J(this), Y(this, e, n, i).split(/\s+/g).forEach(function (t) {
            i = i.replace(I(t), " ");
          }), J(this, i.trim());
        }
      });
      ...
      return e ? this.each(function (r) {
        var o = n(this),
            s = Y(this, e, r, J(this));s.split(/\s+/g).forEach(function (e) {
    ...
    var i = e.replace(/./, function (t) {
      ...
      var o,
          s = this[0];return r === t ? Z(s) ? s["inner" + i] : L(s) ? s.documentElement["scroll" + i] : (o = this.offset()) && o[e] : this.each(function (t) {
  ...
  }), C.Z.prototype = H.prototype = n.fn, C.uniq = P, C.deserializeValue = K, n.zepto = C, n;
  ...
  function l(t) {
    ...
    var e,
        i = { originalEvent: t };for (e in t) x.test(e) || t[e] === n || (i[e] = t[e]);return T(i, t);
  }var n,
      e = 1,
  ...
  function h(e, n, i) {
    ...
    var r = n.context,
        o = "success";n.success.call(r, t, o, e), i && i.resolveWith(r, [t, o, e]), p(n, r, "ajaxSuccess", [e, n, t]), b(o, e, n);
  }function y(t, e, n, i, r) {
    var o = i.context;i.error.call(o, n, e, t), r && r.rejectWith(o, [n, e, t]), p(i, o, "ajaxError", [n, i, t || e]), b(e, n, i);
  }function b(t, e, n) {
    ...
    var a,
        ...
        h = /\?.+=\?/.test(o.url);if (h && (f = "jsonp"), o.cache !== !1 && (e && e.cache === !0 || "script" != f && "jsonp" != f) || (o.url = E(o.url, "_=" + Date.now())), "jsonp" == f) return h || (o.url = E(o.url, o.jsonp ? o.jsonp + "=?" : o.jsonp === !1 ? "" : "callback=?")), t.ajaxJSONP(o, s);var O,
        p = o.accepts[f],
        m = {},
        b = function (t, e) {
      m[t.toLowerCase()] = [t, e];
        ...
        j = o.xhr(),
        C = j.setRequestHeader;if (s && s.promise(j), o.crossDomain || b("X-Requested-With", "XMLHttpRequest"), b("Accept", p || "*/*"), (p = o.mimeType || p) && (p.indexOf(",") > -1 && (p = p.split(",", 2)[0]), j.overrideMimeType && j.overrideMimeType(p)), (o.contentType || o.contentType !== !1 && o.data && "GET" != o.type.toUpperCase()) && b("Content-Type", o.contentType || "application/x-www-form-urlencoded"), o.headers) for (r in o.headers) b(r, o.headers[r]);if (j.setRequestHeader = b, j.onreadystatechange = function () {
      if (4 == j.readyState) {
        j.onreadystatechange = w, clearTimeout(O);var e,
            n = !1;if (j.status >= 200 && j.status < 300 || 304 == j.status || 0 == j.status && "file:" == S) {
          f = f || x(o.mimeType || j.getResponseHeader("content-type")), e = j.responseText;try {
    ...
    }, g(j, o) === !1) return j.abort(), y(null, "abort", j, o, s), j;if (o.xhrFields) for (r in o.xhrFields) j[r] = o.xhrFields[r];var P = "async" in o ? o.async : !0;j.open(o.type, o.url, P, o.username, o.password);for (r in m) C.apply(j, m[r]);return o.timeout > 0 && (O = setTimeout(function () {
      j.onreadystatechange = w, j.abort(), y(null, "timeout", j, o, s);
  ...
  };var j = encodeURIComponent;t.param = function (e, n) {
  ...
  function e(t, e) {
    var n = this.os = {},
        ...
        j = S || t.match(/Version\/([\d.]+)([^S](Safari)|[^M]*(Mobile)[^S]*(Safari))/);(i.webkit = !!r) && (i.version = r[1]), o && (n.android = !0, n.version = o[2]), f && !u && (n.ios = n.iphone = !0, n.version = f[2].replace(/_/g, ".")), a && (n.ios = n.ipad = !0, n.version = a[2].replace(/_/g, ".")), u && (n.ios = n.ipod = !0, n.version = u[3] ? u[3].replace(/_/g, ".") : null), h && (n.wp = !0, n.version = h[1]), c && (n.webos = !0, n.version = c[2]), p && (n.touchpad = !0), g && (n.blackberry = !0, n.version = g[2]), v && (n.bb10 = !0, n.version = v[2]), y && (n.rimtabletos = !0, n.version = y[2]), b && (i.playbook = !0), d && (n.kindle = !0, n.version = d[1]), m && (i.silk = !0, i.version = m[1]), !m && n.android && t.match(/Kindle Fire/) && (i.silk = !0), w && (i.chrome = !0, i.version = w[1]), x && (i.firefox = !0, i.version = x[1]), E && (n.firefoxos = !0, n.version = E[1]), T && (i.ie = !0, i.version = T[1]), j && (s || n.ios || l) && (i.safari = !0, n.ios || (i.version = j[1])), S && (i.webview = !0), n.tablet = !!(a || b || o && !t.match(/Mobile/) || x && t.match(/Tablet/) || T && !t.match(/Phone/) && t.match(/Touch/)), n.phone = !(n.tablet || n.ipod || !(o || f || c || g || v || w && t.match(/Android/) || w && t.match(/CriOS\/([\d.]+)/) || x && t.match(/Mobile/) || T && t.match(/Touch/)));
  ...
  function v(t) {
    ...
    var b,
        ...
        C = !1;if (i === e && (i = t.fx.speeds._default / 1e3), y === e && (y = 0), t.fx.off && (i = 0), "string" == typeof n) w[h] = n, w[p] = i + "s", w[m] = y + "s", w[d] = r || "linear", j = t.fx.animationEnd;else {
      x = [];for (b in n) s.test(b) ? E += b + "(" + n[b] + ") " : (w[b] = n[b], x.push(v(b)));E && (w[a] = E, x.push(a)), i > 0 && "object" == typeof n && (w[u] = x.join(", "), w[f] = i + "s", w[l] = y + "s", w[c] = r || "linear");
    }return S = function (e) {
      if ("undefined" != typeof e) {
        if (e.target !== e.currentTarget) return;t(e.target).unbind(j, S);
      } else t(this).unbind(j, S);C = !0, t(this).css(g), o && o.call(this);
  ...
  function i(t) {
    ...
    var n,
        e = {};t(document).bind("gesturestart", function (t) {
      var r = Date.now();r - (e.last || r);e.target = i(t.target), n && clearTimeout(n), e.e1 = t.scale, e.last = r;
  ...
  String.prototype.trim === t && (String.prototype.trim = function () {
    ...
    if (void 0 === this || null === this) throw new TypeError();var o,
        n = Object(this),
        i = n.length >>> 0,
        r = 0;if ("function" != typeof e) throw new TypeError();if (0 == i && 1 == arguments.length) throw new TypeError();if (arguments.length >= 2) o = arguments[1];else for (;;) {
      if (r in n) {
        o = n[r++];break;
      }if (++r >= i) throw new TypeError();
    }for (; i > r;) r in n && (o = e.call(t, o, n[r], r, n)), r++;return o;
  });
}();
